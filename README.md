...
3. Install ROS dependencies:
    ...
    colcon build --symlink-install --packages-up-to techtory_cobotta_bringup techtory_cobotta_system techtory_hybrid_planning onrobot_rg_description techtory_cobotta_isaacsim techtory_hybrid_planning frame_editor techtory_demo_description_arm_ikfast_plugin frame_editor onrobot_rg_description onrobot_rg_control onrobot_rg_msg onrobot_rg_kinematics 
    ```
