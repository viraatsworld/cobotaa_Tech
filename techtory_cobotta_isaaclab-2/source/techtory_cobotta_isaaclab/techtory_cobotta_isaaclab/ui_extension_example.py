...
def some_public_function(x: int):
    print("[techtory_cobotta_isaaclab] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[techtory_cobotta_isaaclab] startup")
    ...
    def on_shutdown(self):
        print("[techtory_cobotta_isaaclab] shutdown")
