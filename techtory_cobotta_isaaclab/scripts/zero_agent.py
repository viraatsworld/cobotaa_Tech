    ...
    with launch_simulation(env_cfg, args_cli):
        ...
        while True:
            if sim.visualizers:
                ...
                # headless: stop after MAX_STEPS. Without this the loop never
                # ends, because `sim.visualizers` is empty and nothing else
                # breaks -- the comment above promised a fallback that the
