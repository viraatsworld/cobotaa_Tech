...
"""List the environments registered by techtory_cobotta_isaaclab."""
...
importlib.import_module("techtory_cobotta_isaaclab.tasks")
...
def main() -> None:
    """Print the package's registered environments."""
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--keyword", default="TechtoryCobottaIsaaclab-", help="Substring used to filter task ids.")
    ...
    table.title = "Available techtory_cobotta_isaaclab Environments"
